...
public class ControladorUsuario {
    ...
    public String verOferta(Model model, @PathVariable String id_oferta){
        ...
        model.addAttribute("peticiones", peticionDao.getPeticionesParaColaborar(ofertaSeleccionada.getId_Habilidad(), ofertaSeleccionada.getId_Estudiante(), id_oferta));
    ...
    public String verPeticion(Model model, @PathVariable String id_peticion){
        ...
        model.addAttribute("ofertas", ofertaDao.getOfertasParaColaborar(peticionSeleccionada.getId_Habilidad(), peticionSeleccionada.getId_Estudiante(), id_peticion));
